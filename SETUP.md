...
[`v1.3.2` release](https://github.com/n624-dev/latex-renderer/releases/tag/v1.3.2).
It includes `latex-renderer-server-1.3.2.tar.gz`, with a SHA-256 digest reported
