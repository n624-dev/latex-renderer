...
[`v1.1.5` release](https://github.com/n624-dev/latex-renderer/releases/tag/v1.1.5).
It includes `latex-renderer-server-1.1.5.tar.gz`, with a SHA-256 digest reported
