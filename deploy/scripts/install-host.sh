...
apt-get update
DEBIAN_FRONTEND=noninteractive apt-get install -y ca-certificates curl age apparmor apparmor-utils jq openssl rsync sqlite3 uidmap dbus-user-session slirp4netns fuse-overlayfs xz-utils
