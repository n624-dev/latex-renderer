...
export default tseslint.config(
  ...
  // Unmodified, hash-pinned historical Node CLI used by compatibility tests.
  { files: ["tests/fixtures/rc3-runtime-image-identity.mjs"], languageOptions: { globals: { process: "readonly" } } },
